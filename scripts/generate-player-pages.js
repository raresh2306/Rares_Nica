...
const players = require('../js/playerData.js');
...
const template = (player) => `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <title>FC Barcelona - ${player.name}</title>
  </head>
  <body id="player-profile" data-player-slug="${player.slug}">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item text-primary" href="../team.html">Men's Team</a>
                </li>
                <li>
                  <a class="dropdown-item text-primary" href="../team-women.html">Women's Team</a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item text-primary" href="../matches.html">Men's Matches</a>
                </li>
                <li>
                  <a class="dropdown-item text-primary" href="../matches-women.html">Women's Matches</a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-md-4 my-3">
            ...
            <ul class="list-unstyled">
              <li>
                Important: <a href="../privacy.html">Privacy Policy</a>
              </li>
              <li>
                Useful: <a href="../gallery.html">Gallery</a>,
...
players.forEach((player) => {
  const filePath = path.join(playersDir, `${player.slug}.html`);
  fs.writeFileSync(filePath, template(player));
