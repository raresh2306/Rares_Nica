...
<html lang="en">
  <head>
    ...
    <title>Vetra | Software Solutions</title>
  </head>
  <body id="home">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 my-3">
              <h6>About Vetra</h6>
              <p>
                Vetra is a dedicated software solutions company that aims to provide
            ...
            <div class="col-md-4 my-3">
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  Useful: <a href="index.php#expertise">Expertise</a>,
                  <a href="index.php#pricing">Pricing</a>,
                  <a href="index.php#newsletter">Newsletter</a>
                </li>
                <li>
                  Menu: <a href="index.php">Home</a>, <a href="index.php#details">Details</a>,
