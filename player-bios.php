...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Player Bios</title>
  </head>
  <body id="player-bios">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item text-primary" href="team.php"
                    >Men's Team</a
                  >
                </li>
                <li>
                  <a class="dropdown-item text-primary" href="team-women.php"
                    >Women's Team</a
                  >
                </li>
              </ul>
      ...
      <div class="container py-5">
        <div class="row align-items-center">
          <div class="col-lg-8">
            ...
            <div class="mt-4">
              <a href="team.php" class="btn btn-primary me-2">Back to Team</a>
              <a href="#biosContainer" class="btn btn-outline-light"
                >Browse bios</a
              >
            </div>
          </div>
    ...
    <main class="py-6">
      <div class="container">
        <div id="biosContainer" class="d-flex flex-column gap-5"></div>
      </div>
    </main>
