...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Marc Casadó</title>
  </head>
  <body id="player-profile" data-player-slug="marc-casado">
        ...
        <div class="row">
          <div class="col-lg-10">
            ...
            <h1 class="xl-text text-secondary">
              Marc Casadó
              <span class="text-primary fw-bold">#17</span>
            </h1>
            <p class="lead mb-0">La Masía trained midfielder known for hard work, quality, and leadership</p>
          </div>
        </div>
      </div>
    </header>
