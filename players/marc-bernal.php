...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Marc Bernal</title>
  </head>
  <body id="player-profile" data-player-slug="marc-bernal">
        ...
        <div class="row">
          <div class="col-lg-10">
            ...
            <h1 class="xl-text text-secondary">
              Marc Bernal
              <span class="text-primary fw-bold">#22</span>
            </h1>
            <p class="lead mb-0">Holding midfielder with great tactical awareness and defensive abilities</p>
          </div>
        </div>
      </div>
    </header>
