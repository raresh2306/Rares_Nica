...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Hansi Flick</title>
  </head>
  <body id="player-profile" data-player-slug="hansi-flick">
    ...
    <header class="header position-relative">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            <p class="text-uppercase text-primary fw-semibold mb-2">Coach profile</p>
            <h1 class="xl-text text-secondary">
              Hansi Flick
              
            </h1>
            <p class="lead mb-0">The German coach is known for his tactical prowess and ability to lead the team to success.</p>
          </div>
        </div>
      </div>
    </header>
