...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Ferran Torres</title>
  </head>
  <body id="player-profile" data-player-slug="ferran-torres">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">He brings together various talents which allow him to operate anywhere up front</p>
          </div>
        </div>
      </div>
    </header>
