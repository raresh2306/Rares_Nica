...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Jules Koundé</title>
  </head>
  <body id="player-profile" data-player-slug="jules-kounde">
        ...
        <div class="row">
          <div class="col-lg-10">
            ...
            <h1 class="xl-text text-secondary">
              Jules Koundé
              <span class="text-primary fw-bold">#23</span>
            </h1>
            <p class="lead mb-0">Jules Kounde is known for being a very fast defender, quick to intercept, and being good on the ball.</p>
          </div>
        </div>
      </div>
    </header>
