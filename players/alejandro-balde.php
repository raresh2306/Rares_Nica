...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Alejandro Balde</title>
  </head>
  <body id="player-profile" data-player-slug="alejandro-balde">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">Skill and strength make Alejandro Balde a fast, explosive fullback who can also support the attack</p>
          </div>
        </div>
      </div>
    </header>
