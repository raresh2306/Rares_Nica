...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Szczesny</title>
  </head>
  <body id="player-profile" data-player-slug="szczesny">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">With an admirable career in goal for Arsenal, Roma, and Juventus, Szczęsny is a vastly experienced international goalkeeper</p>
          </div>
        </div>
      </div>
    </header>
