...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Gerard Maldini</title>
  </head>
  <body id="player-profile" data-player-slug="gerard-martin">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">Versatile defender who can play at left back or centre back</p>
          </div>
        </div>
      </div>
    </header>
