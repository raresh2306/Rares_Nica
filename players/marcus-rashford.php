...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Marcus Rashford</title>
  </head>
  <body id="player-profile" data-player-slug="marcus-rashford">
        ...
        <div class="row">
          <div class="col-lg-10">
            ...
            <h1 class="xl-text text-secondary">
              Marcus Rashford
              <span class="text-primary fw-bold">#14</span>
            </h1>
            <p class="lead mb-0">Right footed, he can play anywhere up front, take players on and is an excellent finisher</p>
          </div>
        </div>
      </div>
    </header>
