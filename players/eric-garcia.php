...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Eric García</title>
  </head>
  <body id="player-profile" data-player-slug="eric-garcia">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">Centre back who excels at getting the ball out from the back and has an instinctive ability to read the game</p>
          </div>
        </div>
      </div>
    </header>
