...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Pau Cubarsí</title>
  </head>
  <body id="player-profile" data-player-slug="pau-cubarsi">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">A centre back who provides leadership and decisiveness in defence, while also being able to bring the ball out.</p>
          </div>
        </div>
      </div>
    </header>
