...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Lamine Yamal</title>
  </head>
  <body id="player-profile" data-player-slug="lamine-yamal">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">A great talent from La Masia who stands out for his daring dribbling</p>
          </div>
        </div>
      </div>
    </header>
