...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Ronald Araújo</title>
  </head>
  <body id="player-profile" data-player-slug="ronald-araujo">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">Uruguayan defender, strong in the air and capable with the ball at his feet.</p>
          </div>
        </div>
      </div>
    </header>
