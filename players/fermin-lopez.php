...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Fermín López</title>
  </head>
  <body id="player-profile" data-player-slug="fermin-lopez">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">Culer since 2016/17, the midfielder from La Masia is now an established first team player.</p>
          </div>
        </div>
      </div>
    </header>
