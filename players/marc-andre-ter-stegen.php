...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Marc-André ter Stegen</title>
  </head>
  <body id="player-profile" data-player-slug="marc-andre-ter-stegen">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">A keeper with great reflexes and also excellent with the ball at his feet.</p>
          </div>
        </div>
      </div>
    </header>
