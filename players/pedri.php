...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Pedri</title>
  </head>
  <body id="player-profile" data-player-slug="pedri">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">The player enjoys playing on the front foot, driving at his direct opponent and having his passes break the defensive lines.</p>
          </div>
        </div>
      </div>
    </header>
