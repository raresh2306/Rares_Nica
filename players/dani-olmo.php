...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Dani Olmo</title>
  </head>
  <body id="player-profile" data-player-slug="dani-olmo">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">A goalscorer and a versatile addition who can in midfield or up front</p>
          </div>
        </div>
      </div>
    </header>
