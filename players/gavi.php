...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Gavi</title>
  </head>
  <body id="player-profile" data-player-slug="gavi">
      ...
      <div class="container py-5">
        <div class="row">
          <div class="col-lg-10">
            ...
            <p class="lead mb-0">Technically gifted midfielder with plenty of character and a good reader of the game.</p>
          </div>
        </div>
      </div>
    </header>
