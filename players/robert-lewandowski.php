...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Robert Lewandowski</title>
  </head>
  <body id="player-profile" data-player-slug="robert-lewandowski">
        ...
        <div class="row">
          <div class="col-lg-10">
            ...
            <h1 class="xl-text text-secondary">
              Robert Lewandowski
              <span class="text-primary fw-bold">#9</span>
            </h1>
            <p class="lead mb-0">Polish international and one of the world's most prolific strikers. Known for his clinical finishing and aerial ability.</p>
          </div>
        </div>
      </div>
    </header>
