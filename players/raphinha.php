...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Raphinha</title>
  </head>
  <body id="player-profile" data-player-slug="raphinha">
        ...
        <div class="row">
          <div class="col-lg-10">
            ...
            <h1 class="xl-text text-secondary">
              Raphinha
              <span class="text-primary fw-bold">#11</span>
            </h1>
            <p class="lead mb-0">A technically gifted, skill winger with great dribbling skills and combination play</p>
          </div>
        </div>
      </div>
    </header>
