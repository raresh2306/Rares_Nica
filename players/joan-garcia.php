...
<html lang="en">
  <head>
    ...
    <title>FC Barcelona - Joan Garcia</title>
  </head>
  <body id="player-profile" data-player-slug="joan-garcia">
        ...
        <div class="row">
          <div class="col-lg-10">
            ...
            <h1 class="xl-text text-secondary">
              Joan Garcia
              <span class="text-primary fw-bold">#13</span>
            </h1>
            <p class="lead mb-0">A goalkeeper with tremendous reflexes who can also play with the ball at his feet</p>
          </div>
        </div>
      </div>
    </header>
